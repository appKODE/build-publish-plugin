...
mavenPublishing {
    coordinates(artifactId = "build-publish-novo-client-jira")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("Build Publish Novo Client Jira")
        description.set("Jira HTTP client library for Build Publish plugins")
