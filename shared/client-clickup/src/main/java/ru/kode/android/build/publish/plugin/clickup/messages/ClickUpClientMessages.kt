...
fun addingTagToTasksMessage(
    tag: String,
    count: Int,
): String = "Adding tag '$tag' to $count ClickUp tasks"

fun addingFixVersionToTasksMessage(
    version: String,
    count: Int,
): String = "Adding fix version '$version' to $count ClickUp tasks"
