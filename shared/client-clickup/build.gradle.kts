...
mavenPublishing {
    coordinates(artifactId = "build-publish-novo-client-clickup")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("Build Publish Novo Client ClickUp")
        description.set("ClickUp HTTP client library for Build Publish plugins")
