...
mavenPublishing {
    coordinates(artifactId = "build-publish-novo-client-telegram")

    publishToMavenCentral()
    signAllPublications()

    pom {
        name.set("Build Publish Novo Client Telegram")
        description.set("Telegram HTTP client library for Build Publish plugins")
