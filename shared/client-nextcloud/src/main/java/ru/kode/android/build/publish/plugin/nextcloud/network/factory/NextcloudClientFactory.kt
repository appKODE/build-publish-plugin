...
import ru.kode.android.build.publish.plugin.nextcloud.messages.eofDuringHandShakeMessage
import ru.kode.android.build.publish.plugin.nextcloud.messages.ioExceptionMessage
import ru.kode.android.build.publish.plugin.nextcloud.messages.sslHandShakeMessage
...
/**
 * Factory for creating OkHttpClient instances with the necessary configuration for Nextcloud API communication.
 */
internal object NextcloudClientFactory {
    /**
     * Creates an OkHttpClient instance with the necessary configuration for Nextcloud API communication.
     *
...
/**
 * Creates an OkHttpClient.Builder instance with the necessary configuration for Nextcloud API communication.
 *
 * @param logger The logger instance for logging.
 * @param username The username for basic authentication.
 * @param password The password for basic authentication.
