...
mavenPublishing {
    coordinates(artifactId = "build-publish-novo-client-slack")

    publishToMavenCentral()
    signAllPublications()

    pom {
        name.set("Build Publish Novo Client Slack")
        description.set("Slack HTTP client library for Build Publish plugins")
