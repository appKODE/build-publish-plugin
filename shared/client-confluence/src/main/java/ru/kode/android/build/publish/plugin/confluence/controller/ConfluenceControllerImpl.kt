...
import ru.kode.android.build.publish.plugin.confluence.messages.addCommentFailedMessage
import ru.kode.android.build.publish.plugin.confluence.messages.removeAttachmentFailedMessage
import ru.kode.android.build.publish.plugin.confluence.messages.removeCommentFailedMessage
...
internal class ConfluenceControllerImpl(
    ...
    override fun uploadFile(
        ...
        api
            ...
            .executeNoResult()
            .getOrElse { throw IllegalStateException(uploadFileFailedMessage(file.name, pageId), it) }
    }
    ...
    override fun addComment(
        ...
        api
            ...
            .executeNoResult()
            .getOrElse { throw IllegalStateException(addCommentFailedMessage(pageId, fileName), it) }
    }
    ...
    override fun removeAttachment(attachmentId: String) {
        api
            ...
            .executeNoResult()
            .getOrElse { throw IllegalStateException(removeAttachmentFailedMessage(attachmentId), it) }
    }
    ...
    override fun removeComment(commentId: String) {
        api
            ...
            .executeNoResult()
            .getOrElse { throw IllegalStateException(removeCommentFailedMessage(commentId), it) }
    }
}
