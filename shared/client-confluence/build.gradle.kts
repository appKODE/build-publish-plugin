...
mavenPublishing {
    coordinates(artifactId = "build-publish-novo-client-confluence")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("Build Publish Novo Client Confluence")
        description.set("Confluence HTTP client library for Build Publish plugins")
