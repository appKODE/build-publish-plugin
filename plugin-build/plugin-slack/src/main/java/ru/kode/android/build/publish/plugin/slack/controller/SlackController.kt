...
/**
 * Abstraction over Slack operations used by the plugin.
 */
interface SlackController {
     ...
     *
     * @param webhookUrl URL of the Slack webhook to send the message to
     ...
     * @param issueUrlPrefix URL prefix used to build links to issues (e.g. "https://tracker/browse/")
