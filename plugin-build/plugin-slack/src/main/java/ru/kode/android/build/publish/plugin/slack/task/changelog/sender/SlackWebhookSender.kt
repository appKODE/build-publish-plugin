package ru.kode.android.build.publish.plugin.slack.task.changelog.sender
...
import ru.kode.android.build.publish.plugin.slack.task.changelog.sender.api.SlackWebhookSenderApi
