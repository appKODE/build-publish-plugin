...
interface JiraAutomationParameters : WorkParameters {
...
abstract class JiraAutomationWork : WorkAction<JiraAutomationParameters> {
    ...
    override fun execute() {
        ...
        issues.forEach { issue ->
            service.addLabel(issue, parameters.label.get())
        }
    }
}
