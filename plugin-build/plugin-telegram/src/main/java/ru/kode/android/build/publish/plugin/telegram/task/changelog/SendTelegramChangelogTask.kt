 ...
 * - Escapes special characters for Telegram's HTML format
...
abstract class SendTelegramChangelogTask
    ...
    constructor(
         ...
         * [ru.kode.android.build.publish.plugin.foundation.task.tag.GetLastTagSnapshotTask].
         */
        @get:InputFile
        @get:Option(
         ...
         * 4. Escapes special characters for Telegram's HTML format
