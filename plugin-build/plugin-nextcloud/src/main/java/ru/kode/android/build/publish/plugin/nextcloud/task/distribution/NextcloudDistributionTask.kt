package ru.kode.android.build.publish.plugin.nextcloud.task.distribution
...
import ru.kode.android.build.publish.plugin.nextcloud.task.resolveArtifactRemoteFileName
import javax.inject.Inject

@DisableCachingByDefault
abstract class NextcloudDistributionTask
    @Inject
    constructor(
        private val workerExecutor: WorkerExecutor,
    ) : DefaultTask() {
        init {
            description = "Uploads distribution files to Nextcloud"
        ...
        fun upload() {
            ...
            val compressed = compressed.orElse(false).get()
