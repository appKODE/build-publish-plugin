...
/**
 * Gradle plugin that wires AppCenter configuration and network services into the Android build.
 *
 * This plugin integrates AppCenter distribution capabilities into the Android build process,
 * allowing for seamless upload of APKs to AppCenter for distribution.
 *
 * @see BuildPublishAppCenterExtension For available configuration options
 * @see AppCenterNetworkService For the network service implementation
 */
