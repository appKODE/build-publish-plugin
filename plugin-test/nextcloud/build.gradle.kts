...
tasks.test {
    systemProperty("NEXTCLOUD_BASE_URL", project.getEnvOrProperty("NEXTCLOUD_BASE_URL"))
    systemProperty("NEXTCLOUD_USER_NAME", project.getEnvOrProperty("NEXTCLOUD_USER_NAME"))
    systemProperty("NEXTCLOUD_USER_PASSWORD", project.getEnvOrProperty("NEXTCLOUD_USER_PASSWORD"))
    systemProperty("NEXTCLOUD_REMOTE_PATH", project.getEnvOrProperty("NEXTCLOUD_REMOTE_PATH"))
    systemProperty("NEXTCLOUD_USER_RECIPIENT", project.getEnvOrProperty("NEXTCLOUD_USER_RECIPIENT"))
    systemProperty("NEXTCLOUD_GROUP_RECIPIENT", project.getEnvOrProperty("NEXTCLOUD_GROUP_RECIPIENT"))
