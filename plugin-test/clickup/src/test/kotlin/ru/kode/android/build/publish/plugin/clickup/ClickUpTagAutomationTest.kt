...
class ClickUpTagAutomationTest {
    ...
    fun `clickup tag automation executes with automation config`() {
    ...
    @Test
    @Throws(IOException::class)
    fun `clickup tag automation executes with automation config and without assemble`() {
        val workspaceName = "Ilia Nekrasov's Workspace"
    ...
    @Test
    @Throws(IOException::class)
    fun `clickup tag automation executes when task already has tag`() {
        val workspaceName = "Ilia Nekrasov's Workspace"
    ...
    @Test
    @Throws(IOException::class)
    fun `clickup tag automation executes when task already has tag and without assemble`() {
        val workspaceName = "Ilia Nekrasov's Workspace"
